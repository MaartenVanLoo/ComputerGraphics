...
void WoodTexture::preview(double x0, double x1, double y0, double y1) {
    ...
    for (int x = 0; x < 512; x++){
        for (int y = 0; y < 512; y++){
            ...
            Color3 c = Color3(this->compute(x0+p.get<_X>()*(x1-x0)/255,y0 + p.get<_Y>()*(y1-y0)/255,p.get<_Z>()));
